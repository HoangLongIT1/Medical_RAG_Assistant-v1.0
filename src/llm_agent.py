...
- **KHÔNG BAO GIỜ** in ra tên file raw (VD: `tieuduong_type2_byt_2020.pdf`). Thay vì vậy, luôn BẮT BUỘC phiên dịch tên file thành tên tài liệu dễ đọc, chuyên nghiệp (VD: "Hướng dẫn chẩn đoán và điều trị Hô hấp, Bộ Y Tế", "Phác đồ đái tháo đường típ 2, Bộ Y tế 2020").
